...
function test_ivent(e) {
  ...
  if (e.key === 'Enter') {
    ...
    var currentTaskId = Number(this.parentElement.previousElementSibling.innerText);
    var nextTaskId = currentTaskId + 1;
    ...
    document.getElementById(inputForm.id).focus();
      ...
      var parentId = previousRow.getElementById('task_id'); //親IDを取得

      console.log; //子タスクIDの生成
      //子タスクIDの書き換え
...
/******/ });
//# sourceMappingURL=index-09734911a6c027850776.js.map